...
開発初期の実装は、Antigravity（AIエージェント）に要件と作りたいものを丸投げする形で進めました。実際に私が入力したプロンプトは以下の通りです。
...
驚くべきことに、このような具体的なプロンプトを示すだけで、アプリのコアとなる要件定義から実際のコード生成までがスムーズに進み、この一連の指示だけでアプリのベースはほぼ完成してしまいました。
